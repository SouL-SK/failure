...
public class message {
	...
	public void 이동(michael_RPG.character character, michael_RPG.monster monster) {
	...
	public void 체력포션(michael_RPG.character character) {
	...
	public void 마나포션(michael_RPG.character character) {
